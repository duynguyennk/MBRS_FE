...
@Component({
  selector: 'app-list-booking-detail',
  templateUrl: './list-booking-detail.component.html',
  styleUrls: ['./list-booking-detail.component.css']
})
export class ListBookingDetailComponent implements OnInit {
  isLoading = false
  roomInformation : any;
  page: number = 1;
  count: number = 0;
