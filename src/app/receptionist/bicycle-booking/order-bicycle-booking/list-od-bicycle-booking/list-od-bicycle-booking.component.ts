...
@Component({
  selector: 'app-list-od-bicycle-booking',
  templateUrl: './list-od-bicycle-booking.component.html',
  styleUrls: ['./list-od-bicycle-booking.component.css']
})
export class ListOdBicycleBookingComponent implements OnInit {
  ...
  constructor(private orderBikeService: OrderBikeService,private confirmationErrDialog:ConfirmationErrDialogService ) { 
  ...
  onSubmit() {
    ...
    this.orderBikeService.getTypeBike(this.searchForm.value).subscribe(res => {
      ...
      {
        this.confirmationErrDialog.confirm(Constant.loadData.title,Constant.loadData.errData)
      }
    })
    }
  }
