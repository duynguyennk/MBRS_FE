...
@Component({
  selector: 'app-list-od-food-booking',
  templateUrl: './list-od-food-booking.component.html',
  styleUrls: ['./list-od-food-booking.component.css'],
})
export class ListOdFoodBookingComponent implements OnInit {
  currentRate = 3;
  listFood: any;
  isLoading = false;
  objectJason: any;
  ...
  onSearchChange(orderInformation: any) {
    ...
    if (this.foodOrder.length != 0) {
      ...
      this.router.navigateByUrl(
        '/receptionist/food-booking/order-food-booking/make-od-food-booking'
      );
    } else {
      this.confirmationErrDialogService.confirm(
