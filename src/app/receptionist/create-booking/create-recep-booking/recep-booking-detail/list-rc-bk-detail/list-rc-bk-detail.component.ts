...
@Component({
  selector: 'app-list-rc-bk-detail',
  templateUrl: './list-rc-bk-detail.component.html',
  styleUrls: ['./list-rc-bk-detail.component.css']
})
export class ListRcBkDetailComponent implements OnInit {
  isLoading = false
  roomInformation : any;
  page: number = 1;
  count: number = 0;
