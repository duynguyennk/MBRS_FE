...
@Component({
  selector: 'app-list-recep-booking',
  templateUrl: './list-recep-booking.component.html',
  styleUrls: ['./list-recep-booking.component.css'],
})
export class ListRecepBookingComponent implements OnInit {
  currentRate = 3;
  typeRoomList: any;
      ...
      this.orderRoomService
        ...
        .subscribe((res) => {
          if (res.code === '200') {
            ...
            this.checkDateCancel = formatDate(
              this.checkDateCancel.setDate(this.checkDateCancel.getDate() - 3),
              'yyyy-MM-dd',
              'en-US'
            );
